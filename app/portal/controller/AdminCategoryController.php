...
class AdminCategoryController extends AdminBaseController
{
    ...
    public function addPost()
    {
        ...
        if (!empty($data['dwxz_id']) && is_array($data['dwxz_id'])) {
            ...
            foreach ($dwxz_ids as $dwxz_id) {
                DB::name("CategoryDwxz")->insert(["dwxz" => $dwxz_id, "category_id" => $portalCategoryModel->id]);
            }
    ...
    public function edit()
    {
        ...
        if ($id > 0) {
            ...
            $dwxz_ids = DB::name('CategoryDwxz')->where(["category_id" => $id])->column("dwxz");
    ...
    public function editPost()
    {
        ...
        if (!empty($data['dwxz_id']) && is_array($data['dwxz_id'])) {
            ...
            $uid = $data['id'];
            DB::name("CategoryDwxz")->where(["category_id" => $uid])->delete();
            foreach ($dwxz_ids as $dwxz_id) {
                DB::name("CategoryDwxz")->insert(["dwxz" => $dwxz_id, "category_id" => $uid]);
            }

            $this->success('保存成功!', 'AdminCategory/index');
        }else{
            $this->error("请选择单位性质！");
        }
