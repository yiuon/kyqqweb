...
parse;
    ...
    public function tagNavigation($tag, $content)
    {
        ...
        $dwxz                   = isset($tag['dwxz']) ? $tag['dwxz'] : 0;
        $area_id                   = isset($tag['area_id']) ? $tag['area_id'] : 0;
        $pagename                   = isset($tag['pagename']) ? $tag['pagename'] : "";
...
<?php
    ...
    \$menus = \$navMenuModel->navMenusTreeArray({$navId},{$maxLevel},{$dwxz},{$area_id},"{$pagename}");
?>
<if condition="'{$root}'==''">
